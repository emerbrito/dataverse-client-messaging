...
namespace EmBrito.Dataverse.Extensions.Tests.Messaging.MessageHandlers
{
    ...
    public class DataverseUpdateEntityNameHandler : DataverseMessageHandler
    {

        public static string? LastUpdatedEntityName { get; set; }

        public static string? EntityNameFilter { get; set; }

        public static string FormatEntityName(string name) => $"{name} - Changed";        
        ...
        {
            LastUpdatedEntityName = FormatEntityName(message.PrimaryEntityName);
